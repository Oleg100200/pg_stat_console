...
(function () {
	...
	function Chart(containerId, options, publicChartReference) {
		...
		this._toolBar.style.cssText = "margin-right:60px; position: absolute; right: 1px; top: 1px;";
	...
	Chart.prototype._updateOptions = function () {
		...
		if (this._options.zoomEnabled) {
			...
			if (!this._zoomButton) {
				...
				hide(this._zoomButton = document.createElement("div"));
			...
			if (!this._resetButton) {
				hide(this._resetButton = document.createElement("div"));
